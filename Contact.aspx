<%@ Page Title="Contact" Language="C#" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="TLDR_Capstone.Contact" %>
...
<body>
  ...
  <body>
	...
	<div class="button-box">
		<li><button class="menu-btn"><a href ="https://few.io/" target="window">Course Catalog</button></a></li>
	...
	<div class="Main">
		<div class="main-box">
			<iframe width="100%" height="100%" name="window" src="https://inthooz.com/"></iframe>
		</div>
	</div>
	<div class="footer">
